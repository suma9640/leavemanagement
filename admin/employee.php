        ...
        <div class="card shadow-lg border-light">
          ...
          <div class="card-body">
            <form id="employeeForm" enctype="multipart/form-data">
              ...
              <!-- Department Dropdown -->
              <div class="form-floating mb-3">
                <select class="form-control" id="employee-department" name="employee_department" required>
                  <option value="" disabled selected>Select Department</option>
                  <!-- Dynamic department options will be inserted here -->
                </select>
              ...
              <div class="form-floating mb-3">
                <textarea class="form-control" id="employee-designation" name="employee_designation" rows="4"
                  required></textarea>
              ...
              <!-- Employee Image -->
              <div class="form-floating mb-3">
                <input type="file" class="form-control" id="employee-image" name="employee_image" accept="image/*"
                  required>
              ...
              <!-- ID Proof Image -->
              <div class="form-floating mb-3">
                <input type="file" class="form-control" id="id-proof-image" name="id_proof_image" accept="image/*"
                  required>
